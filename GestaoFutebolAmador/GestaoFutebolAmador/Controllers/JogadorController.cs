...
namespace GestaoFutebolAmador.Controllers
{
    public class JogadorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeJogador,Mensalista,ObsMensalista,Inativo")] Jogador jogador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeJogador,Mensalista,ObsMensalista,Inativo")] Jogador jogador)
        {
            if (id != jogador.Id)
            {
                return NotFound();
